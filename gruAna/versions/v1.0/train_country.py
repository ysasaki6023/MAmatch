...
from net_country import net,DataAccessor
...
if __name__=="__main__":
    ...
    parser.add_argument("--nLength","-l",dest="nLength",type=int,default=1)
    ...
    n = net_train(args,d,columnPairs=(u"Acquiror country code",u"Target country code"),goodFrac=0.5) # columnPairsはtupleにしないとキャッシュのところで落ちるので注意
    n.train(saveFolder="models/CountryCode_units256_nLength1")
